...
const int StringConstraintSolverOld::VLOG_LEVEL = 13;

StringConstraintSolverOld::StringConstraintSolverOld(Script_ptr script, SymbolTable_ptr symb,
...
StringConstraintSolverOld::~StringConstraintSolverOld() {
}

void StringConstraintSolverOld::start() {
  visitScript(root_);
  end();
}

void StringConstraintSolverOld::start(SMT::Visitable_ptr node) {
  this->Visitor::visit(node);
  end();
}

void StringConstraintSolverOld::end() {
}

void StringConstraintSolverOld::collect_string_constraint_info() {
  string_relation_generator_.start();
}

void StringConstraintSolverOld::setCallbacks() {
...
void StringConstraintSolverOld::visitScript(Script_ptr script) {
  symbol_table_->push_scope(script);
  visit_children_of(script);
  symbol_table_->pop_scope();
}

void StringConstraintSolverOld::visitAssert(Assert_ptr assert_command) {
  DVLOG(VLOG_LEVEL) << "visit: " << *assert_command;
  AstTraverser::visit(assert_command->term);
}

void StringConstraintSolverOld::visitAnd(And_ptr and_term) {
...
void StringConstraintSolverOld::visitOr(Or_ptr or_term) {
...
void StringConstraintSolverOld::visitConcat(Concat_ptr concat_term) {
}

void StringConstraintSolverOld::visitIn(In_ptr in_term) {
}

void StringConstraintSolverOld::visitNotIn(NotIn_ptr not_in_term) {
}

void StringConstraintSolverOld::visitLen(Len_ptr len_term) {
}

void StringConstraintSolverOld::visitContains(Contains_ptr contains_term) {
}

void StringConstraintSolverOld::visitNotContains(NotContains_ptr not_contains_term) {
}

void StringConstraintSolverOld::visitEnds(Ends_ptr ends_term) {
}

void StringConstraintSolverOld::visitNotEnds(NotEnds_ptr not_ends_term) {
}

void StringConstraintSolverOld::visitIndexOf(IndexOf_ptr index_of_term) {
}

void StringConstraintSolverOld::visitLastIndexOf(LastIndexOf_ptr last_index_of_term) {
}

void StringConstraintSolverOld::visitCharAt(CharAt_ptr char_at_term) {
}

void StringConstraintSolverOld::visitSubString(SubString_ptr sub_string_term) {
}

void StringConstraintSolverOld::visitToUpper(ToUpper_ptr to_upper_term) {
}

void StringConstraintSolverOld::visitToLower(ToLower_ptr to_lower_term) {
}

void StringConstraintSolverOld::visitTrim(Trim_ptr trim_term) {
}

void StringConstraintSolverOld::visitReplace(Replace_ptr replace_term) {
}

void StringConstraintSolverOld::visitCount(Count_ptr count_term) {
}

void StringConstraintSolverOld::visitIte(Ite_ptr ite_term) {
}

void StringConstraintSolverOld::visitReConcat(ReConcat_ptr reconcat_term) {
}

void StringConstraintSolverOld::visitToRegex(ToRegex_ptr to_regex_term) {
}

std::string StringConstraintSolverOld::get_string_variable_name(Term_ptr term) {
  std::string group_name = string_relation_generator_.get_term_group_name(term);
  return group_name;
}

Value_ptr StringConstraintSolverOld::get_term_value(Term_ptr term) {
...
bool StringConstraintSolverOld::set_term_value(Term_ptr term, Value_ptr value) {
...
void StringConstraintSolverOld::clear_term_value(SMT::Term_ptr term) {
  auto it = term_values_.find(term);
  if (it != term_values_.end()) {
    delete it->second;
...
Value_ptr StringConstraintSolverOld::get_variable_value(Variable_ptr variable, bool multi_val) {
...
bool StringConstraintSolverOld::update_variable_value(Variable_ptr variable, Value_ptr value) {
...
bool StringConstraintSolverOld::has_variable(Variable_ptr variable) {
  std::string group_name = string_relation_generator_.get_variable_group_name(current_term_,variable);
  if(group_name.empty()) {
    return false;
  }
