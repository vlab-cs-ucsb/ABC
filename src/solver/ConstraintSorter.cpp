...
ConstraintSorter::VisitableNode_ptr ConstraintSorter::process_child_nodes(VisitableNode_ptr left_node, VisitableNode_ptr right_node) {
	VisitableNode_ptr result_node = nullptr;
...
std::string ConstraintSorter::VariableNode::str() {
	std::stringstream ss;
	ss << *(this->variable) << " -> l:" << left_side_var_appearance_list.size() << " r:" << right_side_var_appearance_list.size();
