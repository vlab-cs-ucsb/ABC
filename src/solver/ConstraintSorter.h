...
public:
  ...
  /*
   * Sorting levels are based on whether various tie-breaking techniques are used
   */
  static int SORTING_LEVEL;
...
protected:
  ...
  bool SORT_TOPOLOGICAL; // only valid with count variable
  bool SORT_BY_TYPE; // string/int
  bool SORT_BY_TERM_TYPE; // =, !=, etc...
  bool SORT_BY_TOTAL_VARS;
  bool SORT_BY_LEFT_VARS;
  bool SORT_BY_RIGHT_VARS;
  bool SORT_BY_NUM_OPS; // number of operations in subterms
  bool SORT_BY_TOSTRING; // sort by their respective string representations
