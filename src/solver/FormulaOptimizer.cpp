...
void FormulaOptimizer::visitNot(Not_ptr not_term) {	visit_and_callback(not_term->term); }

void FormulaOptimizer::visitUMinus(UMinus_ptr u_minus_term) { visit_and_callback(u_minus_term->term); }
...
void FormulaOptimizer::visitLen(Len_ptr len_term) {	visit_and_callback(len_term->term); }
