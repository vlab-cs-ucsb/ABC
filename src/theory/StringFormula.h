 ...
 public:
  enum class Type : int {
    NONE = 0, EQ, NOTEQ, GT, GE, LT, LE, DIFFERENCE, VAR, CHARAT,EQ_CHARAT,NOTEQ_CHARAT,
    		GT_CHARAT,GE_CHARAT,LT_CHARAT,LE_CHARAT,LEN, EQ_LEN, NOTEQ_LEN, GT_LEN, GE_LEN, LT_LEN, LE_LEN,
        STRING_CONSTANT, REGEX_CONSTANT, INTEGER_CONSTANT, EQ_NO_LAMBDA, EQ_ONLY_LAMBDA, SUBSTRING,
        BEGINS, BEGINS_SUBSTRING, NOTBEGINS, NOTBEGINS_SUBSTRING, CONCAT_VAR_CONSTANT, INTERSECT, UNION, NONRELATIONAL, NA
  };
