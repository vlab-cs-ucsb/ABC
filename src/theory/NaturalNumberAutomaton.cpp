...
namespace Vlab
{
  namespace Theory
  {
    ...
    const int NaturalNumberAutomaton::VLOG_LEVEL = 9;

    NaturalNumberAutomaton::NaturalNumberAutomaton(const Libs::MONALib::DFA_ptr dfa, const int number_of_bdd_variables)
        : Automaton(dfa, number_of_bdd_variables),
          formula_ { nullptr }
    {
    }

    NaturalNumberAutomaton::NaturalNumberAutomaton(const Libs::MONALib::DFA_ptr dfa, const ArithmeticFormula_ptr formula)
        : Automaton(dfa, formula->get_number_of_variables()),
          formula_ { formula }
    {
    }

    NaturalNumberAutomaton::NaturalNumberAutomaton(const NaturalNumberAutomaton& other)
        : Automaton(other)
    {
      if (other.formula_)
      {
    ...
    NaturalNumberAutomaton::~NaturalNumberAutomaton()
    {
      delete formula_;
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::Clone() const
    {
      NaturalNumberAutomaton_ptr cloned_auto = new NaturalNumberAutomaton(*this);
      DVLOG(VLOG_LEVEL) << cloned_auto->id_ << " = [" << this->id_ << "]->Clone()";
      return cloned_auto;
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeAutomaton(const Libs::MONALib::DFA_ptr dfa,
                                                           const int number_of_bdd_variables) const
    {
      return new NaturalNumberAutomaton(dfa, number_of_bdd_variables);
    }

    std::string NaturalNumberAutomaton::Str() const
    {
      std::stringstream ss;
      ss << "NaturalNumberAutomaton[" << id_ << "]";
      return ss.str();
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakePhi(ArithmeticFormula_ptr formula, bool is_natural_number)
    {
      auto non_accepting_dfa = Libs::MONALib::DFAMakePhi(formula->get_number_of_variables());
      auto non_accepting_binary_auto = new NaturalNumberAutomaton(non_accepting_dfa, formula, is_natural_number);
     ...
     */
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeAnyInt(ArithmeticFormula_ptr formula, bool is_natural_number)
    {
      auto any_binary_int_dfa = Automaton::DFAMakeAnyButNotEmpty(formula->get_number_of_variables());
      auto any_int = new NaturalNumberAutomaton(any_binary_int_dfa, formula, is_natural_number);

      DVLOG(VLOG_LEVEL) << any_int->id_ << " = MakeAnyInt(" << *formula << ")";
      return any_int;
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeAutomaton(ArithmeticFormula_ptr formula, bool is_natural_number)
    {
      NaturalNumberAutomaton_ptr result_auto = nullptr;

      switch (formula->get_type())
      {
        case ArithmeticFormula::Type::EQ: {
          result_auto = NaturalNumberAutomaton::MakeEquality(formula, is_natural_number);
          break;
        }
        ...
        case ArithmeticFormula::Type::GT: {
          result_auto = NaturalNumberAutomaton::MakeGreaterThan(formula, is_natural_number);
          break;
        }
        case ArithmeticFormula::Type::GE: {
          result_auto = NaturalNumberAutomaton::MakeGreaterThanOrEqual(formula, is_natural_number);
          break;
        }
        case ArithmeticFormula::Type::LT: {
          result_auto = NaturalNumberAutomaton::MakeLessThan(formula, is_natural_number);
          break;
        }
        case ArithmeticFormula::Type::LE: {
          result_auto = NaturalNumberAutomaton::MakeLessThanOrEqual(formula, is_natural_number);
          break;
        }
        case ArithmeticFormula::Type::VAR: {
          CHECK_EQ(1, formula->get_number_of_variables());
          result_auto = NaturalNumberAutomaton::MakeAnyInt(formula, is_natural_number);
          break;
        }
        default:
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeAutomaton(int value, std::string var_name,
                                                           ArithmeticFormula_ptr formula, bool add_leading_zeros)
    {
      ...
      auto binary_auto = NaturalNumberAutomaton::MakeAutomaton(constant_value_formula, not add_leading_zeros);

      DVLOG(VLOG_LEVEL) << binary_auto->GetId() << " = NaturalNumberAutomaton::MakeAutomaton(" << value << ", " << var_name
                           << ", " << *formula << ", " << std::boolalpha << add_leading_zeros << ")";
      return binary_auto;
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeAutomaton(SemilinearSet_ptr semilinear_set, std::string var_name,
                                                           ArithmeticFormula_ptr formula, bool add_leading_zeros)
    {
      DVLOG(VLOG_LEVEL) << "NaturalNumberAutomaton::MakeAutomaton(" << *semilinear_set << ", " << var_name;
      ...
      auto binary_auto = new NaturalNumberAutomaton(dfaMinimize(binary_dfa), formula, not add_leading_zeros);
      dfaFree(binary_dfa);
      binary_dfa = nullptr;
      ...
      {
        auto trim_helper_auto = NaturalNumberAutomaton::MakeTrimHelperAuto(var_index, number_of_variables);
      ...
      DVLOG(VLOG_LEVEL) << binary_auto->GetId() << " = NaturalNumberAutomaton::MakeAutomaton(<semilinear_set>, " << var_name
                           << ", " << *(binary_auto->formula_) << ", " << std::boolalpha << add_leading_zeros << ")";
      return binary_auto;
    }

    ArithmeticFormula_ptr NaturalNumberAutomaton::get_formula()
    {
      return formula_;
    }

    void NaturalNumberAutomaton::set_formula(ArithmeticFormula_ptr formula)
    {
      this->formula_ = formula;
    }

    bool NaturalNumberAutomaton::is_natural_number()
    {
      return is_natural_number_;
    }

    bool NaturalNumberAutomaton::HasNegative1()
    {
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::Complement()
    {
      DFA_ptr complement_dfa = dfaCopy(this->dfa_);

      dfaNegation(complement_dfa);

      auto tmp_auto = new NaturalNumberAutomaton(complement_dfa, this->formula_->clone(), is_natural_number_);
      // a complemented auto may have initial state accepting, we should be safely avoided from that
      auto any_int_auto = NaturalNumberAutomaton::MakeAnyInt(this->formula_->clone(), is_natural_number_);
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::Intersect(NaturalNumberAutomaton_ptr other_auto)
    {
      ...
      auto intersect_auto = new NaturalNumberAutomaton(intersect_dfa, intersect_formula, is_natural_number_);

      DVLOG(VLOG_LEVEL) << intersect_auto->id_ << " = [" << this->id_ << "]->Intersect(" << other_auto->id_ << ")";
      return intersect_auto;
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::Union(NaturalNumberAutomaton_ptr other_auto)
    {
      ...
      auto union_auto = new NaturalNumberAutomaton(union_dfa, union_formula, is_natural_number_);

      DVLOG(VLOG_LEVEL) << union_auto->id_ << " = [" << this->id_ << "]->Union(" << other_auto->id_ << ")";
      return union_auto;
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::Difference(NaturalNumberAutomaton_ptr other_auto)
    {
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::Exists(std::string var_name)
    {
      LOG(FATAL)<< "implement me";
      return nullptr;
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::GetBinaryAutomatonFor(std::string var_name)
    {
      ...
      auto single_var_auto = new NaturalNumberAutomaton(single_var_dfa, single_var_formula, is_natural_number_);

      DVLOG(VLOG_LEVEL) << single_var_auto->id_ << " = [" << this->id_ << "]->GetBinaryAutomatonOf(" << var_name << ")";
      return single_var_auto;
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::GetPositiveValuesFor(std::string var_name)
    {
      std::vector<int> indexes;
      int var_index = formula_->get_variable_index(var_name);
      indexes.push_back(var_index);

      auto greater_than_or_equalt_to_zero_auto = NaturalNumberAutomaton::MakeIntGraterThanOrEqualToZero(
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::GetNegativeValuesFor(std::string var_name)
    {
      NaturalNumberAutomaton_ptr negatives_auto = nullptr;
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::TrimLeadingZeros()
    {
      ...
      auto trim_helper_auto = NaturalNumberAutomaton::MakeTrimHelperAuto(0,number_of_bdd_variables_);
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::AddLeadingZeros()
    {
      LOG(FATAL)<< "implement me (similar to string->toUnary function)";
      NaturalNumberAutomaton_ptr leading_zero_auto = nullptr;
     ...
     *
     */
    SemilinearSet_ptr NaturalNumberAutomaton::GetSemilinearSet()
    {
      SemilinearSet_ptr semilinear_set = nullptr, current_set = nullptr, tmp_set = nullptr;
      NaturalNumberAutomaton_ptr subject_auto = nullptr, tmp_1_auto = nullptr, tmp_2_auto = nullptr, diff_auto = nullptr;
      ...
      if (semilinear_set->has_constants())
      {
        ...
        semilinear_set->set_constants(constants);
        constants.clear();
        tmp_1_auto = NaturalNumberAutomaton::MakeAutomaton(semilinear_set, var_name, formula_->clone(), false);
          ...
          for (auto it = bases.begin(); it < bases.end() - 1; it++)
          {
            ...
            for (auto jt = it + 1; jt < bases.end(); jt++)
            {
              ...
              if (add_me)
              {
                ...
                tmp_1_auto = NaturalNumberAutomaton::MakeAutomaton(current_set, var_name, formula_->clone(), false);
    ...
    UnaryAutomaton_ptr NaturalNumberAutomaton::ToUnaryAutomaton()
    {
      UnaryAutomaton_ptr unary_auto = nullptr;
      NaturalNumberAutomaton_ptr trimmed_auto = nullptr;
    ...
    std::map<std::string, int> NaturalNumberAutomaton::GetAnAcceptingIntForEachVar()
    {
    ...
    void NaturalNumberAutomaton::decide_counting_schema(Eigen::SparseMatrix<BigInteger>& count_matrix)
    {
      if (is_natural_number_)
      {
    ...
    BigInteger NaturalNumberAutomaton::SymbolicCount(double bound, bool count_less_than_or_equal_to_bound)
    {
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeIntGraterThanOrEqualToZero(std::vector<int> indexes,
                                                                            int number_of_variables)
    {
      ...
      auto postivie_numbers_auto = new NaturalNumberAutomaton(positive_numbers_dfa, number_of_variables, false);

      delete[] bin_variable_indices;

      DVLOG(VLOG_LEVEL) << postivie_numbers_auto->id_
                        << " = [NaturalNumberAutomaton]->MakeIntGraterThanOrEqualToZero(<indexes>, " << number_of_variables
                        << ")";
      return postivie_numbers_auto;
    }

    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeEquality(ArithmeticFormula_ptr formula, bool is_natural_number)
    {
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeIntEquality(ArithmeticFormula_ptr formula)
    {
      if (not formula->Simplify())
      {
        auto equality_auto = NaturalNumberAutomaton::MakePhi(formula, false);
      ...
      auto equality_auto = new NaturalNumberAutomaton(equality_dfa, formula, false);
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeNaturalNumberEquality(ArithmeticFormula_ptr formula)
    {
      if (not formula->Simplify())
      {
        auto equality_auto = NaturalNumberAutomaton::MakePhi(formula, true);
      ...
      auto equality_auto = new NaturalNumberAutomaton(equality_dfa, formula, true);
      CHECK_EQ(false, equality_auto->IsInitialStateAccepting());
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeLessThan(ArithmeticFormula_ptr formula, bool is_natural_number)
    {
      if (is_natural_number)
      {
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeIntLessThan(ArithmeticFormula_ptr formula)
    {
      formula->Simplify();
      ...
      auto less_than_auto = new NaturalNumberAutomaton(less_than_dfa, formula, false);
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeNaturalNumberLessThan(ArithmeticFormula_ptr formula)
    {
      formula->Simplify();
      ...
      auto less_than_auto = new NaturalNumberAutomaton(less_than_dfa, formula, true);
      CHECK_EQ(false, less_than_auto->IsInitialStateAccepting());
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeLessThanOrEqual(ArithmeticFormula_ptr formula, bool is_natural_number)
    {
      ...
      auto less_than_or_equal_auto = NaturalNumberAutomaton::MakeLessThan(less_than_formula, is_natural_number);
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeGreaterThan(ArithmeticFormula_ptr formula, bool is_natural_number)
    {
      auto less_than_formula = formula->Multiply(-1);
      less_than_formula->set_type(ArithmeticFormula::Type::LT);

      auto greater_than_auto = NaturalNumberAutomaton::MakeLessThan(less_than_formula, is_natural_number);
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeGreaterThanOrEqual(ArithmeticFormula_ptr formula,
                                                                    bool is_natural_number)
    {
      ...
      auto greater_than_or_equal_auto = NaturalNumberAutomaton::MakeLessThan(less_than_formula, is_natural_number);
    ...
    NaturalNumberAutomaton_ptr NaturalNumberAutomaton::MakeTrimHelperAuto(int var_index, int number_of_variables)
    {
      char statuses[5] = { '-', '+', '+', '-', '-' };
      ...
      auto trim_helper_auto = new NaturalNumberAutomaton(trim_helper_dfa, number_of_variables, false);

      delete[] indices;
      delete[] exception;

      DVLOG(VLOG_LEVEL) << trim_helper_auto->id_ << " = [NaturalNumberAutomaton]->MakeTrimHelperAuto(" << var_index << ", "
                        << number_of_variables << ")";
      return trim_helper_auto;
    }

    void NaturalNumberAutomaton::ComputeBinaryStates(std::vector<BinaryState_ptr>& binary_states,
     ...
     */
    void NaturalNumberAutomaton::AddBinaryState(std::vector<BinaryState_ptr>& binary_states, std::vector<int>& constants)
    {
    ...
    int NaturalNumberAutomaton::AddBinaryState(std::vector<BinaryState_ptr>& binary_states, int C, int R, BinaryState::Type t,
                                         int v, int b)
    {
      unsigned i = 0;
      int d0 = -1, d1 = -1;
    ...
    bool NaturalNumberAutomaton::is_accepting_binary_state(BinaryState_ptr binary_state, SemilinearSet_ptr semilinear_set)
    {
    ...
    bool NaturalNumberAutomaton::GetCycleStatus(std::map<int, bool>& cycle_status)
    {
    ...
    void NaturalNumberAutomaton::GetCycleStatus(int state, std::map<int, int>& disc, std::map<int, int>& low,
...
//  std::cout << "visiting: " << state << std::endl;
    ...
    void NaturalNumberAutomaton::GetConstants(std::map<int, bool>& cycle_status, std::vector<int>& constants)
    {
      std::vector<bool> path;
    ...
    void NaturalNumberAutomaton::GetConstants(int state, std::map<int, bool>& cycle_status, std::vector<bool>& path,
     ...
     */
//bool NaturalNumberAutomaton::getConstants(std::vector<int>& constants) {
//  std::map<int, int> disc;
//  std::map<int, int> low;
//  std::map<int, bool> is_stack_member;
//  std::vector<int> st;
...
//}
//
//bool NaturalNumberAutomaton::getConstants(int state, std::map<int, int>& disc, std::map<int, int>& low, std::vector<int>& st,
...
//  return is_in_cycle;
//}
    void NaturalNumberAutomaton::GetBaseConstants(std::vector<int>& constants, unsigned max_number_of_bit_limit)
    {
     ...
     */
    void NaturalNumberAutomaton::GetBaseConstants(int state, unsigned char *is_visited, std::vector<bool>& path,
...
//void NaturalNumberAutomaton::getBaseConstants2(std::vector<int>& constants) {
...
// * @returns populated constants, ignores the value of initial state whether is an accepted or not
// */
//void NaturalNumberAutomaton::getBaseConstants(int state, bool *is_stack_member, std::vector<bool>& path, std::vector<int>& constants) {
//  int next_state = 0;
//  std::vector<char> exception = {'0'};
//  int l, r;
//
...
//}
    ...
    void NaturalNumberAutomaton::add_print_label(std::ostream& out)
    {
