...
(assert (ite T_SELECT_2 
	(and (= PCTEMP_LHS_2 (+ I0_7 0))(= var_0xINPUT_5121 (str.++ T0_7 T1_7))(= I0_7 (str.len T4_7))(= 0 (str.len T0_7))(= T1_7 (str.++ T2_7 T3_7))(= T2_7 (str.++ T4_7 T5_7))(= T5_7 "#")(not (str.in.re T4_7 (str.to.re "#")))) 
	(and (= PCTEMP_LHS_2 (- 1))(= var_0xINPUT_5121 (str.++ T0_7 T1_7))(= 0 (str.len T0_7))(not (str.in.re T1_7 (str.to.re "#"))))))
