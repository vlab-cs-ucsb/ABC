...
(assert (ite T_SELECT_1 
	(and (= PCTEMP_LHS_1 (+ I0_3 0))(= var_0xINPUT_6552 (str.++ T0_3 T1_3))(= I0_3 (str.len T4_3))(= 0 (str.len T0_3))(= T1_3 (str.++ T2_3 T3_3))(= T2_3 (str.++ T4_3 T5_3))(= T5_3 "?")(not (str.in.re T4_3 (str.to.re "?")))) 
	(and (= PCTEMP_LHS_1 (- 1))(= var_0xINPUT_6552 (str.++ T0_3 T1_3))(= 0 (str.len T0_3))(not (str.in.re T1_3 (str.to.re "?"))))))
